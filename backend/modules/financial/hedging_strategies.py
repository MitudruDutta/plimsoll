...
class FuelHedgingStrategy:
    ...
    def _calculate_option_cost(
        ...
        # Intrinsic value
        intrinsic = max(strike - spot_price, 0) if is_put else max(spot_price - strike, 0)
...
def create_comprehensive_hedge_strategy(
    ...
    total_protection = (
        fuel_strategy.expected_protection_usd + currency_strategy.expected_protection_usd
    )
