...
/**
 * UTC Time Utilities
 * Standardized UTC time formatting utilities
 */
...
/**
 * Format UTC time in short format (HH:MM:SS)
 */
...
/**
 * Format UTC date and time in localized format
 * @param date - Date object, ISO string, or timestamp
 */
...
/**
 * Get individual UTC time components
 */
